...
const NewsLater = () => {
    return (
        <div className="max-w-screen-2xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 xl:px-10">
            <div className="w-full rounded-xl shadow-md border text-light bg-dark">
                <section
                    style={{
                        backgroundImage:
                ...
                >
                    <div className=" mx-auto p-0.5  rounded-2xl bg-black/25">
